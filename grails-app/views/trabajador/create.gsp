...
<div class="card">
    ...
    <div class="card-header">
        ...
        <h3>
            <strong>
                <g:message code="Nuevo trabajador" args="['Create']"/>
            </strong>
        </h3>
    </div>
    ...
    <table>
        <td style="width:60%">
            <div class="card-body">
                ...
                <g:form controller="trabajador" action="save">
                    ...
                    <div class="form-action-panel" align="center">
                        ...
                        <g:link controller="trabajador" action="index" class="btn btn-primary" style="color:#FFFFFF; background-color:#4682B4">
        ...
        <td>
            <div align="center">
                <asset:image src="trabajador.png" class="create-trabajador" width="580" height="350"/>
            </div>
        </td>
