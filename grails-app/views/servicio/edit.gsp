...
<div class="card">
    ...
    <div class="card-header">
        ...
        <h3>
            <strong>
                <g:message code="Actualizar Servicio" args="['Update']"/>
            </strong>
        </h3>
    </div>
    ...
    <table>
        <td style="width:60%">
            ...
            <div class="card-body">
                ...
                <g:form controller="servicio" action="update">
                    ...
                    <div class="form-action-panel" align="center">
                        ...
                        <g:link controller="servicio" action="index" class="btn btn-primary" style="color:#FFFFFF; background-color:#4682B4">
        ...
        <td style="width:50%">
            <div align="center">
                <asset:image src="fondo.jpg" class="create-servicio" width="580" height="350"/>
            </div>
        </td>
